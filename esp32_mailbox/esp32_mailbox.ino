...
#define LED_ENABLED true  //do we want to turn on the on-board LED when connected to WiFi? 
#define MAX_OPENDOOR_TIME 60000   //default 60s in milliseconds how long to wait while door is open to consider it stuck open 
...
#define  message_door_open "Someone opened your door! Get that MF!"
...
int send_SMS(String message)
{
      ...
      { 
        http.begin("ifttturl"); //add your ifttt webhooks url under "ifttturl"
...
void loop() 
{
://www.abrandao.com/2018/03/arduino_esp32_battery_wifi_door_mailbox_sensor
*/
